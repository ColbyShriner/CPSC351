...
$events = [];
$result = $conn->query("SELECT Event.EventDate, location.LocationName, Event.EventName, Event.EventDescription FROM Event JOIN location ON Event.LOCATION_LocationID = location.LocationID");
